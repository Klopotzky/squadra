...
from editor.library.SqFileDb import SqFileDb
...
def app_page(request):
    ...
    return render(request, 'user/editor/app_page.html', context)
...
def ajax_storage_content(request):
    ...
    return render(request, 'user/editor/storage.html', context)
...
def export_file(request):
    ...
    for file in filenames:
        with open("C:\\Users\\Adrian\\Desktop\\Studia\\Squadra materiały\\squadra_main 26.11\\squadra_main\\pliki\\" + file,
                  'rb') as f:
            data = f.read()
            print("data ", data)
