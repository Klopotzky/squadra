...
class Board(models.Model):
    ...
    id_user = models.ForeignKey(User, blank=True, null=True, related_name='%(class)s_requests_user', on_delete=models.SET_NULL)
    id_creator = models.ForeignKey(User, blank=False, null=False, related_name='%(class)s_requests_creator',  on_delete=models.CASCADE)
